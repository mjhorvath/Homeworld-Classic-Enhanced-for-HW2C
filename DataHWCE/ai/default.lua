...
--function aitrace(sString)
--	local newString = "AITRACE: Player" .. s_playerIndex .. ": "  .. sString
--	print(newString)
--end
...
function oninit()
	-- these values only need to be greater than one if DEFINED ROLES is enabled (and only in some instances)
	s_numAlliesToCount = 1
	s_numEnemiesToCount = 1
	...
	sg_doupgrades = 1
	sg_domilitary = 1
	-- new variables for DEFINED ROLES
	sg_dofighters = 1
	sg_docorvettes = 1
	sg_dofrigates = 1
...
--		s_enemyTotalValue = PlayersMilitary_Total(player_enemy, player_max)
	...
	aitrace("Threat level: " .. UnderAttackThreat())
end
