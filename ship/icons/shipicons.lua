...
-- HWC Hacks
Hgn_Carrier_nores = Hgn_Carrier
Hgn_Shipyard_nores = Hgn_Shipyard
Hgn_Mothership_nores = Hgn_MotherShip
Hgn_Battlecruiser_nores = Hgn_BattleCruiser
Hgn_C_Module_FireControl_nores = Icon_Subsystem_FireControl
Hgn_MS_Module_FireControl_nores = Icon_Subsystem_FireControl
Vgr_Carrier_carrieronly = Vgr_Carrier
Vgr_C_Production_Fighter_carrieronly = Vgr_C_Production_Fighter
Vgr_C_Production_Corvette_carrieronly = Vgr_C_Production_Corvette
